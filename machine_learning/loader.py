...
# data_example_2 = [3000.00, 3000.00, 1.0, 0.0, 1.0,
#                   'free', 'buy_it_now', 'active', '', 'ARS',
#                   True, False, False, False, False, False, True]
# data_example_2 = [["bronze", "buy_it_now", True, False, "active", "", "ARS", False, True, False, False, True, 60.0, 60.0, 9, 1, 9],
data_example_2 = [["bronze", 60.0, 60.0, 9, 1, 9], ["free", 60.0, 60.0, 9, 1, 9]]

# df = pd.DataFrame({'listing_type_id': pd.Series(dtype='object'),
#                    'base_price': pd.Series(dtype='float'),
#                    'price': pd.Series(dtype='float'),
#                    'initial_quantity': pd.Series(dtype='float'),
#                    'sold_quantity': pd.Series(dtype='float'),
#                    'available_quantity': pd.Series(dtype='float')})
# for r in data_example_2:
